 ...
 */
void
transfer_8to16copy(int16_t *  dst,
				   uint8_t *  src,
					 uint32_t stride)
{
	uint32_t i, j;
 ...
 */
void
transfer_16to8copy(uint8_t *  dst,
					 int16_t *  src,
					 uint32_t stride)
{
	uint32_t i, j;
