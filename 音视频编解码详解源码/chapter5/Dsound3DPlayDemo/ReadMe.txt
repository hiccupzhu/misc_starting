================================================================================
    MICROSOFT 基础类库： Dsound3DPlayDemo 项目概述
===============================================================================

应用程序向导已为您创建了此 Dsound3DPlayDemo 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 Dsound3DPlayDemo 应用程序的每个文件的内容摘要。
...
Dsound3DPlayDemo.h
    ...
    CDsound3DPlayDemoApp 应用程序类。

Dsound3DPlayDemo.cpp
    这是包含应用程序
    类 CDsound3DPlayDemoApp 的主应用程序源文件。
...
res\Dsound3DPlayDemo.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 Dsound3DPlayDemo.rc 中。

res\Dsound3DPlayDemo.rc2
    此文件包含不由 Microsoft 
...
应用程序向导将创建一个对话框类：
Dsound3DPlayDemoDlg.h、Dsound3DPlayDemoDlg.cpp - 对话框
    这些文件包含 CDsound3DPlayDemoDlg 类。  此类定义
    应用程序主对话框的行为。  此对话框的模板包含在 
    Dsound3DPlayDemo.rc 中，而此文件可以在 Microsoft Visual C++ 中进行编辑。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 Dsound3DPlayDemo.pch 的预编译头文件 (PCH)
