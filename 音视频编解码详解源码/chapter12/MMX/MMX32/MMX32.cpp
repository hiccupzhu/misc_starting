...
- inverting;
- converting colors (multiplication of each color component to some coefficient).

For inverting operation MMX code performs much better (about 30%) than pure C++ code. 


For colors transformation Assembly code runs 5-10% faster than pure C++ code.
C++ code with MMX Intrinsics runs with the same speed like pure C++ code.
...
BEGIN_MESSAGE_MAP(CMMX32App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, OnAppAbout)
END_MESSAGE_MAP()


// CMMX32App construction
...
// The one and only CMMX32App object

CMMX32App theApp;

// CMMX32App initialization

BOOL CMMX32App::InitInstance()
{
