...
extern const int H264_me_lambda_vec16[32];
...
uint8_t *
H264_me_interpolate8x8qpel(const int x, const int y, const uint32_t block,
							const uint32_t dir, const SearchData * const data);

uint8_t *
H264_me_interpolate16x16qpel(const int x, const int y, const uint32_t dir,
							const SearchData * const data);

int32_t
H264_me_ChromaSAD(const int dx, const int dy, SearchData * const data);
...
MainSearchFunc H264_me_DiamondSearch, H264_me_AdvDiamondSearch, H264_me_SquareSearch;

void
H264_me_SubpelRefine(VECTOR centerMV, SearchData * const data, CheckFunc * const CheckCandidate, int dir);
