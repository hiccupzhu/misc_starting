 ...
 *
 *  Copyright(C) 2002-2003 Michael Militzer <isibaar@H264.org>
...
int enc_create(H264_enc_create_t * create);
int enc_destroy(Encoder * pEnc);
int enc_encode(Encoder * pEnc,
				   H264_enc_frame_t * pFrame,
