...
#if defined(_DEBUG)
extern unsigned int H264_debug;
#define DPRINTF_BUF_SZ  1024
#endif

/*****************************************************************************
 *  Types used in H264 sources
 ****************************************************************************/
...
#    endif
#else
#    error You are trying to compile H264 without defining address bus size.
#endif
 ...
 *---------------------------------------------------------------------------*/
#    else
#        error You are trying to compile H264 without defining the architecture type.
#    endif
