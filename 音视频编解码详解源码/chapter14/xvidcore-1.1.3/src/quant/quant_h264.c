 ...
 *  - MPEG4 Quantization h264 implementation -
 *
 ...
 *
 * $Id: quant_h264.c,v 1.8 2004/03/22 22:36:24 edgomez Exp $
 *
 ****************************************************************************/
...
/* Quant */
quant_intraFuncPtr quant_h264_intra;
quant_interFuncPtr quant_h264_inter;

/* DeQuant */
quant_intraFuncPtr dequant_h264_intra;
quant_interFuncPtr dequant_h264_inter;
...
uint32_t
quant_h264_intra_c(int16_t * coeff,
				   const int16_t * data,
...
uint32_t
quant_h264_inter_c(int16_t * coeff,
				   const int16_t * data,
				   const uint32_t quant,
				   const uint16_t * mpeg_quant_matrices)
{
...
uint32_t
dequant_h264_intra_c(int16_t * data,
					 const int16_t * coeff,
					 const uint32_t quant,
					 const uint32_t dcscalar,
					 const uint16_t * mpeg_quant_matrices)
...
uint32_t
dequant_h264_inter_c(int16_t * data,
					 const int16_t * coeff,
					 const uint32_t quant,
					 const uint16_t * mpeg_quant_matrices)
{
