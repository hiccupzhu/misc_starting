...
; *
; * $Id: quantize_h264_3dne.asm,v 1.5 2004/08/29 10:02:38 edgomez Exp $
; *
; *************************************************************************/
;
...
;-----------------------------------------------------------------------------
;
; uint32_t quant_h264_intra_3dne(int16_t * coeff,
...
ALIGN 16
cglobal quant_h264_intra_3dne
quant_h264_intra_3dne:
...
;-----------------------------------------------------------------------------
;
; uint32_t quant_h264_inter_3dne(int16_t * coeff,
;                                const int16_t const * data,
;                                const uint32_t quant,
;                                const uint16_t *mpeg_matrices);
;
...
ALIGN 16
cglobal quant_h264_inter_3dne
quant_h264_inter_3dne:
  mov edx, [esp  + 4]               ; coeff
  mov ecx, [esp  + 8]               ; data
  mov eax, [esp  + 12]              ; quant
  push ebx
...
;-----------------------------------------------------------------------------
;
; uint32_t dequant_h264_intra_3dne(int16_t *data,
...
ALIGN 16
cglobal dequant_h264_intra_3dne
dequant_h264_intra_3dne:
  mov ecx, [esp+ 8]                 ; coeff
  mov eax, [esp+12]                 ; quant
  pxor mm0, mm0
  pxor mm2, mm2
...
;-----------------------------------------------------------------------------
;
; uint32_t dequant_h264_inter_3dne(int16_t * data,
;                                  const int16_t * const coeff,
;                                  const uint32_t quant,
;                                  const uint16_t *mpeg_matrices);
;
...
ALIGN 16
cglobal dequant_h264_inter_3dne
dequant_h264_inter_3dne:
  mov ecx, [esp+ 8]         ; coeff
  mov eax, [esp+12]         ; quant
  pxor mm0, mm0
  pxor mm2, mm2
