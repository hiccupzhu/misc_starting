...
#ifdef DEBUG
	if((long)data & 0xf)
		fprintf(stderr, "H264core: error in dequant_mpeg_intra_altivec_c, incorrect align: %x\n", data);
#endif
...
#ifdef DEBUG
	if((long)data & 0xf)
		fprintf(stderr, "H264core: error in dequant_mpeg_inter_altivec_c, incorrect align: %x\n", data);
#endif
