...
check_cpu_features:
 ...
 ; RDTSC command ?
  CHECK_FEATURE CPUID_TSC, H264_CPU_TSC, ebp

  ; MMX support ?
  CHECK_FEATURE CPUID_MMX, H264_CPU_MMX, ebp

  ; SSE support ?
  CHECK_FEATURE CPUID_SSE, (H264_CPU_MMXEXT|H264_CPU_SSE), ebp

  ; SSE2 support?
  CHECK_FEATURE CPUID_SSE2, H264_CPU_SSE2, ebp
 ...
 ; AMD cpu ?
  ...
  ; 3DNow! support ?
  CHECK_FEATURE EXT_CPUID_3DNOW, H264_CPU_3DNOW, ebp

  ; 3DNOW extended ?
  CHECK_FEATURE EXT_CPUID_AMD_3DNOWEXT, H264_CPU_3DNOWEXT, ebp

  ; extended MMX ?
  CHECK_FEATURE EXT_CPUID_AMD_MMXEXT, H264_CPU_MMXEXT, ebp
