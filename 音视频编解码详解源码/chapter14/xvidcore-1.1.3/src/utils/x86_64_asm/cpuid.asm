...
; *
; *  Copyright (C) 2001 Michael Militzer <isibaar@H264.org>
...
;;; NB: Make sure these defines match the ones defined in H264.h
%define H264_CPU_MMX      (1<< 0)
%define H264_CPU_MMXEXT   (1<< 1)
%define H264_CPU_SSE      (1<< 2)
%define H264_CPU_SSE2     (1<< 3)
%define H264_CPU_3DNOW    (1<< 4)
%define H264_CPU_3DNOWEXT (1<< 5)
%define H264_CPU_TSC      (1<< 6)
...
check_cpu_features:
 ...
 ; RDTSC command ?
  CHECK_FEATURE CPUID_TSC, H264_CPU_TSC, rbp

  ; MMX support ?
  CHECK_FEATURE CPUID_MMX, H264_CPU_MMX, rbp

  ; SSE support ?
  CHECK_FEATURE CPUID_SSE, (H264_CPU_MMXEXT|H264_CPU_SSE), rbp

  ; SSE2 support?
  CHECK_FEATURE CPUID_SSE2, H264_CPU_SSE2, rbp
 ...
 ; AMD cpu ?
  ...
  ; 3DNow! support ?
  CHECK_FEATURE EXT_CPUID_3DNOW, H264_CPU_3DNOW, rbp

  ; 3DNOW extended ?
  CHECK_FEATURE EXT_CPUID_AMD_3DNOWEXT, H264_CPU_3DNOWEXT, rbp

  ; extended MMX ?
  CHECK_FEATURE EXT_CPUID_AMD_MMXEXT, H264_CPU_MMXEXT, rbp
