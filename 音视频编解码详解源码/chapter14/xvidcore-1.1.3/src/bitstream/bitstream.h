...
//luhanyu
#define VIDOBJLAY_START_CODE	0x00000168
//luhanyu
#define VISOBJSEQ_START_CODE	0x00000001
//luhanyu
#define VISOBJ_START_CODE		0x00158a8b
//luhanyu
#define VOP_START_CODE			0x00000165
...
of 4bytes are applicable, define H264_SAFE_BS_TAIL. Note that this will
slow decoding, so consider this as a last-resort solution */
/* #define H264_SAFE_BS_TAIL */
