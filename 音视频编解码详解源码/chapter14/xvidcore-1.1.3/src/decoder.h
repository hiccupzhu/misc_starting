...
typedef struct
{
	...
	/* The bitstream version if it's a H264 stream */
	int bs_version;
	...
	H264_image_t* out_frm;                /* This is used for slice rendering */
...
int decoder_create(H264_dec_create_t * param);
