...
#ifndef _H264_QPEL_H_
#define _H264_QPEL_H_
...
#define H264_QP_PASS_SIGNATURE(NAME)  \
  void (NAME)(uint8_t *dst, const uint8_t *src, int32_t length, int32_t BpS, int32_t rounding)

typedef  H264_QP_PASS_SIGNATURE(H264_QP_PASS);

/* We put everything in a single struct so it can easily be passed
 * to prediction functions as a whole... */

typedef struct _H264_QP_FUNCS {

	/* filter for QPel 16x? prediction */

	H264_QP_PASS *H_Pass;
	H264_QP_PASS *H_Pass_Avrg;
	H264_QP_PASS *H_Pass_Avrg_Up;
	H264_QP_PASS *V_Pass;
	H264_QP_PASS *V_Pass_Avrg;
	H264_QP_PASS *V_Pass_Avrg_Up;

    /* filter for QPel 8x? prediction */

	H264_QP_PASS *H_Pass_8;
	H264_QP_PASS *H_Pass_Avrg_8;
	H264_QP_PASS *H_Pass_Avrg_Up_8;
	H264_QP_PASS *V_Pass_8;
	H264_QP_PASS *V_Pass_Avrg_8;
	H264_QP_PASS *V_Pass_Avrg_Up_8;
} H264_QP_FUNCS;

/*****************************************************************************
 * fwd dcl
 ****************************************************************************/
extern void H264_Init_QP();

extern H264_QP_FUNCS H264_QP_Funcs_C_ref;       /* for P-frames */
extern H264_QP_FUNCS H264_QP_Add_Funcs_C_ref;   /* for B-frames */

extern H264_QP_FUNCS H264_QP_Funcs_C;       /* for P-frames */
extern H264_QP_FUNCS H264_QP_Add_Funcs_C;   /* for B-frames */

#ifdef ARCH_IS_IA32
extern H264_QP_FUNCS H264_QP_Funcs_mmx;
extern H264_QP_FUNCS H264_QP_Add_Funcs_mmx;
#endif

#ifdef ARCH_IS_PPC
extern H264_QP_FUNCS H264_QP_Funcs_Altivec_C;
extern H264_QP_FUNCS H264_QP_Add_Funcs_Altivec_C;
#endif

#ifdef ARCH_IS_X86_64
extern H264_QP_FUNCS H264_QP_Funcs_x86_64;
extern H264_QP_FUNCS H264_QP_Add_Funcs_x86_64;
#endif

extern H264_QP_FUNCS *H264_QP_Funcs;      /* <- main pointer for enc/dec structure */
extern H264_QP_FUNCS *H264_QP_Add_Funcs;  /* <- main pointer for enc/dec structure */
								...
								const uint32_t rounding)
{
	...
	Ops = H264_QP_Add_Funcs;
	Ops_Copy = H264_QP_Funcs;
	quads = (dx&3) | ((dy&3)<<2);
