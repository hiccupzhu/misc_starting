...
cglobal H264_H_Pass_16_mmx
cglobal H264_H_Pass_Avrg_16_mmx
cglobal H264_H_Pass_Avrg_Up_16_mmx
cglobal H264_V_Pass_16_mmx
cglobal H264_V_Pass_Avrg_16_mmx
cglobal H264_V_Pass_Avrg_Up_16_mmx
cglobal H264_H_Pass_8_mmx
cglobal H264_H_Pass_Avrg_8_mmx
cglobal H264_H_Pass_Avrg_Up_8_mmx
cglobal H264_V_Pass_8_mmx
cglobal H264_V_Pass_Avrg_8_mmx
cglobal H264_V_Pass_Avrg_Up_8_mmx

cglobal H264_H_Pass_Add_16_mmx
cglobal H264_H_Pass_Avrg_Add_16_mmx
cglobal H264_H_Pass_Avrg_Up_Add_16_mmx
cglobal H264_V_Pass_Add_16_mmx
cglobal H264_V_Pass_Avrg_Add_16_mmx
cglobal H264_V_Pass_Avrg_Up_Add_16_mmx
cglobal H264_H_Pass_8_Add_mmx
cglobal H264_H_Pass_Avrg_8_Add_mmx
cglobal H264_H_Pass_Avrg_Up_8_Add_mmx
cglobal H264_V_Pass_8_Add_mmx
cglobal H264_V_Pass_Avrg_8_Add_mmx
cglobal H264_V_Pass_Avrg_Up_8_Add_mmx

cextern H264_Expand_mmx

%ifdef USE_TABLES

cextern H264_FIR_1_0_0_0
cextern H264_FIR_3_1_0_0
cextern H264_FIR_6_3_1_0
cextern H264_FIR_14_3_2_1
cextern H264_FIR_20_6_3_1
cextern H264_FIR_20_20_6_3
cextern H264_FIR_23_19_6_3
cextern H264_FIR_7_20_20_6
cextern H264_FIR_6_20_20_6
cextern H264_FIR_6_20_20_7
cextern H264_FIR_3_6_20_20
cextern H264_FIR_3_6_19_23
cextern H264_FIR_1_3_6_20
cextern H264_FIR_1_2_3_14
cextern H264_FIR_0_1_3_6
cextern H264_FIR_0_0_1_3
cextern H264_FIR_0_0_0_1
...
%macro TLOAD 2     ; %1,%2: src pixels
  ...
  movq mm0, [H264_FIR_14_3_2_1 + eax*8 ]
  movq mm3, [H264_FIR_1_2_3_14 + edx*8 ]
  paddw mm0, mm7
  paddw mm3, mm7
%endmacro
...
%macro LOAD 2     ; %1,%2: src pixels
  movzx eax, byte [esi+%1]
  movzx edx, byte [esi+%2]
  movq mm0, [H264_Expand_mmx + eax*8]
  movq mm3, [H264_Expand_mmx + edx*8]
  pmullw mm0, [FIR_R0 ]
  pmullw mm3, [FIR_R16]
  paddw mm0, mm7
  paddw mm3, mm7
...
%macro ACCUM2 4   ;src pixel/Taps/dst regs #1-#2
  movzx eax, byte [esi+%1]
  movq mm4, [H264_Expand_mmx + eax*8]
  movq mm5, mm4
  pmullw mm4, [%2]
  pmullw mm5, [%2+8]
  paddw %3, mm4
...
%else  ; test with unrolling (little faster, but not much)
  ...
  movzx edx, byte [esi+2]
  paddw mm0, [H264_FIR_23_19_6_3 + eax*8]
  paddw mm3, [H264_FIR_1_0_0_0 + eax*8]

  movzx eax, byte [esi+3]
  paddw mm0, [H264_FIR_7_20_20_6 + edx*8]
  paddw mm3, [H264_FIR_3_1_0_0 + edx*8]

  movzx edx, byte [esi+4]
  paddw mm0, [H264_FIR_3_6_20_20 + eax*8]
  paddw mm3, [H264_FIR_6_3_1_0 + eax*8]

  movzx eax, byte [esi+5]
  paddw mm0, [H264_FIR_1_3_6_20 + edx*8]
  paddw mm3, [H264_FIR_20_6_3_1 + edx*8]

  movzx edx, byte [esi+6]
  paddw mm0, [H264_FIR_0_1_3_6 + eax*8]
  paddw mm3, [H264_FIR_20_20_6_3 + eax*8]

  movzx eax, byte [esi+7]
  paddw mm0, [H264_FIR_0_0_1_3 + edx*8]
  paddw mm3, [H264_FIR_6_20_20_7 + edx*8]

  paddw mm0, [H264_FIR_0_0_0_1 + eax*8]
  paddw mm3, [H264_FIR_3_6_19_23 + eax*8]
...
H264_H_Pass_16_mmx:
  H_PASS_16 0, 0
.endfunc
H264_H_Pass_Avrg_16_mmx:
  H_PASS_16 1, 0
.endfunc
H264_H_Pass_Avrg_Up_16_mmx:
  H_PASS_16 2, 0
.endfunc
...
H264_H_Pass_8_mmx:
  H_PASS_8 0, 0
.endfunc
H264_H_Pass_Avrg_8_mmx:
  H_PASS_8 1, 0
.endfunc
H264_H_Pass_Avrg_Up_8_mmx:
  H_PASS_8 2, 0
.endfunc
...
H264_H_Pass_Add_16_mmx:
  H_PASS_16 0, 1
.endfunc
H264_H_Pass_Avrg_Add_16_mmx:
  H_PASS_16 1, 1
.endfunc
H264_H_Pass_Avrg_Up_Add_16_mmx:
  H_PASS_16 2, 1
.endfunc
...
H264_H_Pass_8_Add_mmx:
  H_PASS_8 0, 1
.endfunc
H264_H_Pass_Avrg_8_Add_mmx:
  H_PASS_8 1, 1
.endfunc
H264_H_Pass_Avrg_Up_8_Add_mmx:
  H_PASS_8 2, 1
.endfunc
...
H264_V_Pass_16_mmx:
  V_PASS_16 0, 0
.endfunc
H264_V_Pass_Avrg_16_mmx:
  V_PASS_16 1, 0
.endfunc
H264_V_Pass_Avrg_Up_16_mmx:
  V_PASS_16 2, 0
.endfunc
...
H264_V_Pass_8_mmx:
  V_PASS_8 0, 0
.endfunc
H264_V_Pass_Avrg_8_mmx:
  V_PASS_8 1, 0
.endfunc
H264_V_Pass_Avrg_Up_8_mmx:
  V_PASS_8 2, 0
.endfunc
...
H264_V_Pass_Add_16_mmx:
  V_PASS_16 0, 1
.endfunc
H264_V_Pass_Avrg_Add_16_mmx:
  V_PASS_16 1, 1
.endfunc
H264_V_Pass_Avrg_Up_Add_16_mmx:
  V_PASS_16 2, 1
.endfunc
...
H264_V_Pass_8_Add_mmx:
  V_PASS_8 0, 1
.endfunc
H264_V_Pass_Avrg_8_Add_mmx:
  V_PASS_8 1, 1
.endfunc
H264_V_Pass_Avrg_Up_8_Add_mmx:
  V_PASS_8 2, 1
.endfunc
