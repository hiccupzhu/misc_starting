...
cglobal H264_Copy_Upsampled_8x8_16To8_mmx
cglobal H264_Add_Upsampled_8x8_16To8_mmx
cglobal H264_Copy_Upsampled_8x8_16To8_xmm
cglobal H264_Add_Upsampled_8x8_16To8_xmm

cglobal H264_HFilter_31_mmx
cglobal H264_VFilter_31_x86
cglobal H264_HFilter_31_x86

cglobal H264_Filter_18x18_To_8x8_mmx
cglobal H264_Filter_Diff_18x18_To_8x8_mmx
...
;===========================================================================
;
; void H264_Copy_Upsampled_8x8_16To8_mmx(uint8_t *Dst,
...
align 16
H264_Copy_Upsampled_8x8_16To8_mmx:  ; 344c
...
;===========================================================================
;
; void H264_Add_Upsampled_8x8_16To8_mmx(uint8_t *Dst,
;                                       const int16_t *Src, const int BpS);
;
;===========================================================================
...
align 16
H264_Add_Upsampled_8x8_16To8_mmx:  ; 579c
...
;===========================================================================
;
; void H264_Copy_Upsampled_8x8_16To8_xmm(uint8_t *Dst,
;                                        const int16_t *Src, const int BpS);
;
;===========================================================================
...
align 16
H264_Copy_Upsampled_8x8_16To8_xmm:  ; 315c
...
;===========================================================================
;
; void H264_Add_Upsampled_8x8_16To8_xmm(uint8_t *Dst,
;                                       const int16_t *Src, const int BpS);
;
;===========================================================================

align 16
H264_Add_Upsampled_8x8_16To8_xmm:  ; 549c
...
;===========================================================================
;
; void H264_HFilter_31_mmx(uint8_t *Src1, uint8_t *Src2, int Nb_Blks);
; void H264_VFilter_31_x86(uint8_t *Src1, uint8_t *Src2, const int BpS, int Nb_Blks);
; void H264_HFilter_31_x86(uint8_t *Src1, uint8_t *Src2, int Nb_Blks);
;
;===========================================================================
...
;===========================================================================
;
; void H264_Filter_18x18_To_8x8_mmx(int16_t *Dst,
...
align 16
H264_Filter_18x18_To_8x8_mmx:  ; 283c   (~4.4c per output pixel)
...
;===========================================================================
;
; void H264_Filter_Diff_18x18_To_8x8_mmx(int16_t *Dst,
;                                        const uint8_t *Src, const int BpS);
;
;===========================================================================
...
align 16
H264_Filter_Diff_18x18_To_8x8_mmx:  ; 302c
